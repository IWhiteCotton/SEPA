...
NEORV32_PERIPH_SRC := \
  $(RTL_CORE_SRC)/../periph/wb_pwm.vhd \
  $(RTL_CORE_SRC)/../periph/wb_8_segment.vhd \
  $(RTL_CORE_SRC)/../periph/wb_IR_sensor.vhd \
  $(RTL_CORE_SRC)/../periph/wb_switch.vhd \
  $(RTL_CORE_SRC)/../periph/wb_master_mux.vhd \
  $(RTL_CORE_SRC)/../periph/wb_slave_mux.vhd \
  $(RTL_CORE_SRC)/../periph/wb_arbiter.vhd \
  $(RTL_CORE_SRC)/../periph/wb_slave_sel.vhd
